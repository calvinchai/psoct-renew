...
basename1 = '/local_mount/space/megaera/1/users/kchai/code/psoct-renew/vol_recon_test/process/';
basename2 = '/local_mount/space/megaera/1/users/kchai/code/psoct-renew/vol_recon_test/process/';
slice_numbers = [1];
