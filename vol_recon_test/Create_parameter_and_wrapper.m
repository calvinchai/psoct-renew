clear
addpath('/space/megaera/1/users/kchai/code/psoct-renew/vol_recon_test');

t = tic;
% next step sets path for parameter file put it in your processed directory
ParameterFile  = ['/space/megaera/1/users/kchai/code/psoct-renew/vol_recon_test/Parameters.mat'];
...
Scan.RawDataDir          = '/space/megaera/1/users/kchai/code/psoct-renew/vol_recon_test/rawdata/';
Scan.ProcessDir          = '/space/megaera/1/users/kchai/code/psoct-renew/vol_recon_test/process/';
Scan.TLSS_log            = 'TL_serial_shell_v31_20250919_113218_log.txt'; % used for creating ExperimentBasic
